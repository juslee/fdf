...
/*   Updated: 2024/09/02 10:04:09 by welee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	ft_draw_line_shallow(t_buffer *img, t_vec2i start, t_vec2i end,
// t_wu *vars, t_color color)
// {
// 	int x = start.x + 1;
...
// void	ft_draw_line_steep(t_buffer *img, t_vec2i start, t_vec2i end,
// t_wu *vars, t_color color)
// {
// 	int y = start.y + 1;
