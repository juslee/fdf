...
/*   Updated: 2024/08/15 14:43:51 by welee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_handle_endpoint(t_image *img, t_point p, t_wu vars, int color)
{
	t_point p1, p2;
...
void	ft_draw_line_shallow(t_image *img, t_point start, t_point end, t_wu *vars, int color)
{
	int x = start.x + 1;

	while (x < end.x)
	{
		t_point p1 = {x, (int)vars->inter};
		t_point p2 = {x, (int)vars->inter + 1};
...
void	ft_wu_shallow(t_image *img, t_point start, t_point end, int color)
{
	t_wu vars;
...
void	ft_draw_line_steep(t_image *img, t_point start, t_point end, t_wu *vars, int color)
{
	int y = start.y + 1;

	while (y < end.y)
	{
		t_point p1 = {(int)vars->inter, y};
		t_point p2 = {(int)vars->inter + 1, y};
...
void	ft_wu_steep(t_image *img, t_point start, t_point end, int color)
{
	t_wu vars;
